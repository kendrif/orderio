...
class CommunicationsTest < ApplicationSystemTestCase
  ...
  test "creating a Communication" do
    ...
    fill_in "Company", with: @communication.company
    fill_in "Email", with: @communication.email
    fill_in "Name", with: @communication.name
    fill_in "Phone", with: @communication.phone
    fill_in "Text", with: @communication.text
