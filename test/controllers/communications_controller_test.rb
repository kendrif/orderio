...
class CommunicationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create communication" do
    assert_difference('Communication.count') do
      post communications_url, params: { communication: { company: @communication.company, email: @communication.email, name: @communication.name, phone: @communication.phone, text: @communication.text, title: @communication.title } }
    end
  ...
  test "should update communication" do
    patch communication_url(@communication), params: { communication: { company: @communication.company, email: @communication.email, name: @communication.name, phone: @communication.phone, text: @communication.text, title: @communication.title } }
