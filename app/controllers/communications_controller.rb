class CommunicationsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @communication.save
        format.html { redirect_back fallback_location: root_path, notice: 'Communication was successfully created.' }
  ...
  private
    ...
    def communication_params
      params.require(:communication).permit(:name, :title, :text, :phone, :email, :company)
    end
end
